...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dokumen.nama_dokumen'
        db.alter_column(u'accounts_dokumen', 'nama_dokumen', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Profile.token'
        db.alter_column(u'accounts_profile', 'token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Dokumen.nama_dokumen'
        db.alter_column(u'accounts_dokumen', 'nama_dokumen', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))

        # Changing field 'Profile.token'
        db.alter_column(u'accounts_profile', 'token', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        u'accounts.dokumen': {
            ...
            'nama_dokumen': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        u'accounts.payment': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Pending'", 'max_length': '255', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        u'accounts.prinsip': {
